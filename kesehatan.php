    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="kesehatan">Eye Care</a></li>
                  ...
                  <div class="row">
                    <div class="col-sm-6 mt-2 mt-0">
                      <div class="new_product">
                        <h5 class="text-uppercase">Special Offer</h5>
                        <h3><?= $product; ?></h3>
                        <div class="product-img">
                          <img class="img-fluid" src="assets/img/product/<?= $gambar; ?>" alt="" />
                        </div>
                        <h4>Rp. <?= $harga; ?></h4>
                        <a href="https://api.whatsapp.com/send?phone=<?=$nomor;?>" target="blank" class="main_btn">Make Appointment</a>
                      </div>
                    </div>
              <?php
              }
                    ...
                    ?>
                      <div class="col-6 col-6">
                        <div class="single-product">
                          ...
                          <div class="product-btm d-flex align-items-start flex-column" style="height: 180px;">
                            <a class="d-block">
                              <h4><?= $product; ?></h4>
                            </a>
